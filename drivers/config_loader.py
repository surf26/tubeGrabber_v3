...
class DisplayConfig:
    ...
    preview_detect: bool = True
    show_help: bool = True
    show_slot_panel: bool = True
    show_mapping_table: bool = True
    mapping_table_window: str = "tubeGrabber v3 — 映射表"
...
def load_display(path: Path | None = None) -> DisplayConfig:
    ...
    return DisplayConfig(
        ...
        preview_detect=bool(d.get("preview_detect", True)),
        show_help=bool(d.get("show_help", True)),
        show_slot_panel=bool(d.get("show_slot_panel", True)),
        show_mapping_table=bool(d.get("show_mapping_table", True)),
        mapping_table_window=d.get("mapping_table_window", "tubeGrabber v3 — 映射表"),
